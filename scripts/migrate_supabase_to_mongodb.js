...
const studioSpaces = [
  {
    _id: "st1-manhattan",
    photographer_id: "p1-elena",
    name: "Classic Manhattan Daylight Studio",
    description: "Beautiful high-ceiling studio space with industrial steel windows, white oak floors, and extensive daylight. Ideal for fashion and editorial shoots.",
    location: "New York, NY",
    hourly_rate: 150.00,
    capacity: 20,
    amenities: ["WiFi", "Air Conditioning", "Backdrops", "Lighting Equipment", "Makeup Station", "Changing Room"],
    images: ["https://images.unsplash.com/photo-1598075702185-0c5b2dc0f611?w=800&q=80"],
    is_active: true,
    created_at: new Date(),
    updated_at: new Date()
  },
  {
    _id: "st2-london",
    photographer_id: "p2-arthur",
    name: "Shoreditch Brick Loft Studio",
    description: "Atmospheric, rustic brick wall studio with vintage props, warm tungsten styling, and professional softboxes. Excellent for portrait photography.",
    location: "London, UK",
    hourly_rate: 120.00,
    capacity: 12,
    amenities: ["WiFi", "AC", "Softboxes", "Vintage Furniture", "Free Coffee"],
