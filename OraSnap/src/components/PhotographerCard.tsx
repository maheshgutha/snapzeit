...
export default function PhotographerCard({ photographer }: PhotographerCardProps) {
  ...
  return (
    <Card className="group relative overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-700 bg-white dark:bg-gray-800 rounded-3xl hover:scale-[1.02] hover:-translate-y-2">
